...
class DeviceManager: NSObject {
    ...
    private func getAudioDeviceName(_ deviceID: AudioDeviceID) -> String? {
        ...
        let result = withUnsafeMutablePointer(to: &name) { namePtr in
    ...
    private func getAudioDeviceUID(_ deviceID: AudioDeviceID) -> String? {
        ...
        let result = withUnsafeMutablePointer(to: &uid) { uidPtr in
            AudioObjectGetPropertyData(deviceID, &propertyAddress, 0, nil, &dataSize, uidPtr)
        }
        
        if result == noErr, let uid = uid {
    ...
    private func getAudioDeviceManufacturer(_ deviceID: AudioDeviceID) -> String? {
        ...
        let result = withUnsafeMutablePointer(to: &manufacturer) { manufacturerPtr in
            AudioObjectGetPropertyData(deviceID, &propertyAddress, 0, nil, &dataSize, manufacturerPtr)
        }
        
        if result == noErr, let manufacturer = manufacturer {
